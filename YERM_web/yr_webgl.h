...
#ifndef __YR_WEBGL_H__
#define __YR_WEBGL_H__

#ifndef EMSCRIPTEN
#error "This file must be built by Emscripten"
#endif

#include "../YERM_PC/yr_string.hpp"
#include "../YERM_PC/yr_tuple.hpp"

#include "../YERM_PC/yr_graphics_param.h"
#include "../YERM_PC/yr_math.hpp"
#include "../YERM_PC/yr_threadpool.hpp"
...
namespace onart {
    ...
    class WGLMachine{
        ...
        public:
            ...
            constexpr static bool VULKAN_GRAPHICS = false, D3D12_GRAPHICS = false, D3D11_GRAPHICS = false, OPENGL_GRAPHICS = false, OPENGLES_GRAPHICS = false, METAL_GRAPHICS = false, WEBGL_GRAPHICS = true;
            /// @brief OpenGL 오류 콜백을 사용하려면 이것을 활성화해 주세요.
            constexpr static bool USE_WEBGL_DEBUG = true;
            struct WindowSystem;
    ...
    struct WGLMachine::WindowSystem {
        Window* window;
        uint32_t width, height;
        WindowSystem(Window*);
    };

    class WGLMachine::RenderTarget{
        friend class WGLMachine;
    ...
    class WGLMachine::RenderPass2Cube{
        friend class WGLMachine;
        public:
    ...
    class WGLMachine::StreamTexture {
        friend class WGLMachine;
        friend class RenderPass;
        public:
            /// @brief 사용하지 않는 텍스처 데이터를 정리합니다.
    ...
    struct WGLMachine::PipelineInputVertexSpec {
        int index;
        int offset;
        int dim;
    ...
    class WGLMachine::Pipeline: public align16 {
        friend class WGLMachine;
        private:
    ...
    class WGLMachine::UniformBuffer{
        friend class WGLMachine;
        friend class RenderPass;
        public:
