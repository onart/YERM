...
namespace onart {
    ...
    GLMachine::pPipeline GLMachine::getPipeline(int32_t name){
    ...
    void GLMachine::dropRenderPass(int32_t key) {
        singleton->renderPasses.erase(key);
    }

    void GLMachine::dropRenderPass2Screen(int32_t key) {
        singleton->finalPasses.erase(key);
    }

    void GLMachine::dropShaderModule(int32_t key) {
    ...
    void GLMachine::TextureSet::drop(int32_t key) {
    ...
    GLMachine::pUniformBuffer GLMachine::createUniformBuffer(int32_t key, const UniformBufferCreationOptions& opts) {
    ...
    GLMachine::pRenderPass2Cube GLMachine::createRenderPass2Cube(int32_t key, uint32_t width, uint32_t height, bool useColor, bool useDepth) {
    ...
    GLMachine::pRenderPass2Screen GLMachine::createRenderPass2Screen(int32_t key, int32_t windowIdx, const RenderPassCreationOptions& opts) {
    ...
    GLMachine::pRenderPass GLMachine::createRenderPass(int32_t key, const RenderPassCreationOptions& opts) {
    ...
    GLMachine::pPipeline GLMachine::createPipeline(int32_t key, const PipelineCreationOptions& opts) {
    ...
    void GLMachine::Pipeline::drop(int32_t key) {
    ...
    void GLMachine::UniformBuffer::drop(int32_t key) {
